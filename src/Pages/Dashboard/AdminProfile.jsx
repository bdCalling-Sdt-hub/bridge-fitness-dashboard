    ...
    <div>
      ...
      <div className="flex justify-center items-center flex-col gap-3 bg-[#FEFEFE] py-6 max-w-[840px] mx-auto rounded-lg mt-12 mb-6">
        <div className="w-32 h-32 rounded-full relative">
          ...
          <label
            htmlFor="profile"
            className="absolute bottom-3 bg-white right-1 text-3xl rounded-full p-1 cursor-pointer"
          >
            <RiEditLine />
            <input
              onChange={(e) => {
      ...
      <div className="flex justify-center items-center gap-4">
        <button
          ...
          className={`text-[#6D6D6D] ${
            showEditProfile ? "showProfilePassword" : ""
          }`}
        >
          Edit Profile
        </button>
      ...
      {showEditProfile ? (
        <div className=" bg-[#FEFEFE] py-6 max-w-[840px] mx-auto rounded-lg mt-6 mb-6">
          ...
          >
            <label className="w-[60%] mx-auto">
              ...
              <input
                type="text"
                className="w-full border  outline-none p-3 rounded-md text-[#607888]"
                defaultValue="Asadujjaman "
            ...
            <label className="w-[60%] mx-auto">
              ...
              <input
                type="text"
                className="w-full border  outline-none p-3 rounded-md text-[#607888]"
                defaultValue="79/A Joker Vila, Gotham City"
            ...
            <input
              className="p-3 px-6 rounded-lg cursor-pointer mt-3 bg-[#12354E] text-[#FCFCFC]"
              value={`Save & Change`}
              type="submit"
            />
          </form>
              ...
              <label className="w-full relative">
                ...
                <button className="text-2xl absolute top-[50%] -translate-y-[50%] right-2 hover:scale-105 active:scale-95 transition-all">
                  {oldPasswordType === "password" ? (
                    <FaEyeSlash onClick={() => setoldPasswordType("text")} />
                  ) : (
                    <FaEye onClick={() => setoldPasswordType("password")} />
                  )}
                </button>
              ...
              <label className="w-full relative">
                ...
                <button className="text-2xl absolute top-[50%] -translate-y-[50%] right-2 hover:scale-105 active:scale-95 transition-all">
                  {confirmNewPasswordType === "password" ? (
                    <FaEyeSlash
                      onClick={() => setConfirmNewPasswordType("text")}
                    />
                  ) : (
                    <FaEye
                      onClick={() => setConfirmNewPasswordType("password")}
                    />
                  )}
                </button>
                {errors.currentPassword && (
