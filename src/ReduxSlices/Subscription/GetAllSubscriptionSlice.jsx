...
export const GetAllSubscriptionSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder.addCase(AllSubscription.pending, (state, { payload }) => {
      state.isLoading = true;
    });
    builder.addCase(AllSubscription.fulfilled, (state, { payload }) => {
      console.log(payload);
      state.isError = false;
      state.isSuccess = true;
      state.isLoading = false;
      state.message = payload.message;
      state.allSubscription = payload.data;
    });
    builder.addCase(AllSubscription.rejected, (state, { payload }) => {
      state.isSuccess = false;
      state.isError = true;
      state.isLoading = false;
      state.message = payload.message;
